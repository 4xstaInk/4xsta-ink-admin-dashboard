<template>
  <nav class="navbar navbar-expand-lg navbar-absolute shadow" style="background-color:white"
       :class="{'bg-white': showMenu, 'bg-white': !showMenu}">
    <div class="container-fluid">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" href="javascript:void(0)">Bill Payment</a>
      </div>
